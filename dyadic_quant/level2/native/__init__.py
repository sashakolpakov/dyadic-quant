...
dyadic_qwen_qkv_plan_native_cpu = _LazyNative("dyadic_qwen_qkv_plan_native_cpu")
pack_qwen_qkv_native_cpu = _LazyNative("pack_qwen_qkv_native_cpu")
...
native_rms_norm_cpu = _LazyNative("native_rms_norm_cpu")
