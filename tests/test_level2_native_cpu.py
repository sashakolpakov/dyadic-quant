...
from dyadic_quant.dyadic_torch import encode_model, encode_tensor_per_output_channel
...
def test_native_cpu_grouped_conv2d_matches_level1_baseline():
    build_native_cpu()
